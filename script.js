...
function tampilkanDaftarBuku() {
    ...
    daftarBuku.forEach((buku, index) => {
        ...
        divBuku.innerHTML = `
            ...
            <button 
            class = "bg-[#99b898] mt-1 rounded p-1 hover:bg-green-100 transition"
...
// Fungsi untuk menyimpan buku favorit ke Session Storage
...
window.onload = function () {
    // Memuat daftar buku dari Session Storage
    ...
    // Memuat buku favorit dari Session Storage
    if (sessionStoragelStorage.getItem('bukuFavorit')) {
